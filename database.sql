...
ALTER TABLE ONLY public.message
    ADD CONSTRAINT message_from_id_fkey FOREIGN KEY (from_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.message
    ADD CONSTRAINT message_to_id_fkey FOREIGN KEY (to_id) REFERENCES public.users(id) ON DELETE CASCADE;
